            ...
            <div class="card-body">
                <div class="buyer-info">
                    <div class="buyer-avatar">
                        {{ substr($order->buyer->user->name, 0, 1) }}
                    </div>
                    <div class="buyer-details">
                        ...
                        @if($order->buyer->phone_number)
                            <p class="buyer-phone">
                                <i class="fas fa-phone me-2"></i>{{ $order->buyer->phone_number }}
                            </p>
                        @endif
                    </div>
                </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="address-info">
                    ...
                    <p class="address-city">{{ $order->city }}, {{ $order->postal_code }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="shipping-details">
                    <div class="shipping-item">
                        ...
                        <span class="shipping-value fw-bold">{{ $order->shipping }}</span>
                    </div>
                    <div class="shipping-item">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="shipping" required>
                            ...
                            <option value="JNE" {{ $order->shipping == 'JNE' ? 'selected' : '' }}>JNE</option>
                            <option value="J&T" {{ $order->shipping == 'J&T' ? 'selected' : '' }}>J&T</option>
                            <option value="SiCepat" {{ $order->shipping == 'SiCepat' ? 'selected' : '' }}>SiCepat</option>
                            <option value="Anteraja" {{ $order->shipping == 'Anteraja' ? 'selected' : '' }}>Anteraja</option>
                            <option value="Ninja Express" {{ $order->shipping == 'Ninja Express' ? 'selected' : '' }}>Ninja Express</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="alert alert-info mb-0">
                        ...
                        <small>Pastikan nomor resi sudah benar sebelum disimpan</small>
                    </div>
                </div>
