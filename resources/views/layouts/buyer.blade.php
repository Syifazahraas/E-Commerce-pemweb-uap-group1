                            ...
                            <form action="{{ route('home') }}" method="GET">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="number" name="min_price" value="{{ request('min_price') && request('min_price') >= 0 ? request('min_price') : '' }}" placeholder="0" min="0"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="max_price" value="{{ request('max_price') && request('max_price') >= 0 ? request('max_price') : '' }}" placeholder="10000000" min="0"
                                               class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#60A5FA]">
                                    </div>
